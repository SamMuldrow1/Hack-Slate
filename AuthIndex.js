...
appe.get('/index_login.html', function(req, res){
  res.sendFile(__dirname + '/index_login.html');
});
appe.get('/Main.html', function(req, res){
  res.sendFile(__dirname + '/Main.html');
});
appe.get('/css/style_index_scratch.css', function(req, res){
...
appe.get('/analytics.png', function(req, res){
  res.sendFile(__dirname + '/analytics.png');
});
appe.get('/TOS.html', function(req, res){
